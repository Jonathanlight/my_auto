...
<?php include_once('../../functions/admin/ifLoginConnexion.php'); ?>
...
<html lang="en">
  ...
  <ul class="navbar-nav px-3">
    <li class="nav-item text-nowrap">
      <a class="nav-link btn btn-danger p-2" href="../../functions/logout.php"><i class="fa fa-close"></i> Deconnexion</a>
    </li>
  </ul>
</nav>